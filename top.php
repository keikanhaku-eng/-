...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="css/style.css?v=intro-neon-20260708-2" />
    <script defer src="https://cdn.jsdelivr.net/npm/three@0.160.1/build/three.min.js"></script>
    <script defer src="js/rain-scene.js?v=intro-neon-20260708-2"></script>
    <script defer src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js"></script>
    <script
      defer
      src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/ScrollTrigger.min.js"
    ></script>
    <script defer src="js/script.js?v=intro-neon-20260708-2"></script>
    <script type="module" src="js/rain-glass.js?v=intro-neon-20260708-2"></script>
  </head>
  <body>
